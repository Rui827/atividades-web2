...
class PublisherController extends Controller
{
    ...
    public function update(Request $request, Publisher $publisher)
    {
        ...
        return redirect()->route('publishers.index')->with('success', 'Editor(a) atualizada com sucesso.');
    }
    ...
    public function destroy(Publisher $publisher)
    {
        ...
        return redirect()->route('publishers.index')->with('success', 'Editor(a) excluída com sucesso.');
    }
}
